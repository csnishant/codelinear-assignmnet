...
import homeScreen from "../../assets/homeScreen.png"; // Dynamic Path Configured

export default function DigitalBankingHero() {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-slate-50 via-[#f3f8fc] to-white text-slate-800 overflow-hidden font-sans relative pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-6 items-center pt-16 relative z-10">
        ...
        <div className="lg:col-span-4 flex flex-col justify-center space-y-6 z-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-2 w-full">
            <button className="w-full sm:w-auto px-7 py-3.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-indigo-700 text-white font-bold text-sm rounded-xl shadow-[0_4px_20px_rgba(37,99,235,0.3)] transition-all transform hover:-translate-y-0.5 uppercase tracking-wider">
              Request Demo
            </button>
            <button className="flex items-center justify-center gap-2 text-sm font-bold text-blue-600 hover:text-blue-800 transition-colors py-2 uppercase tracking-wide group w-full sm:w-auto">
              Learn More
              <ArrowRight
                size={16}
        ...
        <div className="lg:col-span-4 flex flex-col justify-center space-y-6 z-10 lg:pl-4">
          <div className="space-y-3">
            <h3 className="text-base font-extrabold text-slate-900 tracking-tight text-left">
              Fully compliant with regulatory requirement
            </h3>
            <p className="text-slate-500 text-xs md:text-sm leading-relaxed font-medium text-left">
              ...
              our risk management framework that is fully integrated.
            </p>
          </div>
          ...
          <ul className="space-y-3.5 pt-2">
            {complianceFeatures.map((feature, idx) => (
              <li
                key={idx}
                className="flex items-center gap-3 text-xs md:text-sm font-bold text-slate-800 group text-left">
                <CheckCircle2
                  size={18}
