    ...
    <div className="relative w-full flex items-center justify-center overflow-hidden py-10 font-sans">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-10 pointer-events-none select-none mix-blend-screen hidden md:block">
          <svg className="w-full h-full object-cover" viewBox="0 0 1200 400" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Structural Graphic Accent lines */}
            <path d="M680 480V-80L940 480V-80" stroke="#00CFFD" strokeWidth="1.2" strokeMiterlimit="10"/>
            <path d="M980 60H1140L1020 480" stroke="#0015CE" strokeWidth="1.2" strokeMiterlimit="10"/>
            <line x1="1000" y1="-120" x2="1180" y2="350" stroke="#00CFFD" strokeWidth="0.5" />
          </svg>
        </div>
